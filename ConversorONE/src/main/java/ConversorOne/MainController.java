...
public class MainController {
  private ConversorMedida conversorMedida = new ConversorMedida();
  private ConversorTemperatura conversorTemperatura = new ConversorTemperatura();
  private ConversorMoeda conversorMoeda = new ConversorMoeda();

  ObservableList<String> escolherMoedaList = FXCollections.observableArrayList("dólar", "euro", "real",
      "libra esterlina", "peso argentino", "peso chileno");
  ObservableList<String> escolherUnidadeList = FXCollections.observableArrayList("quilômetro", "hectômetro",
  ...
  private void converterMoeda() {
    try {
      ...
      String In = escolherMoedaIn.getValue();
      String Out = escolherMoedaOut.getValue();
      moedaResposta.setText(conversorMoeda.convert(valor, In, Out));
  ...
  private void converterUnidade() {
    try {
      ...
      String In = escolherUnidadeIn.getValue();
      String Out = escolherUnidadeOut.getValue();
      double Resposta = conversorMedida.converteM(valor, In);
      String Final = conversorMedida.converterResposta(Resposta, Out);
  ...
  private void converterTemperatura() {
    try {
      ...
      String In = escolherMedidaIn.getValue();
      String Out = escolherMedidaOut.getValue();
      String Final = conversorTemperatura.converteT(valor, In, Out);
